...
export const Header: VFC = memo(() => {
  ...
  return (
    <>
      <Flex as="nav" bg="teal.500" color="gray.50" align="center" justify="space-between" padding={{ base: 3, md: "lg" }}>
      ...
      <Drawer placement="left" size="xm" onClose={onClose} isOpen={isOpen}>
        <DrawerOverlay>
          <DrawerContent>
